...
func (in *ApplicationHealthList) DeepCopyInto(out *ApplicationHealthList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ApplicationHealth, len(*in))
		for i := range *in {
...
func (in *ApplicationHealthList) DeepCopy() *ApplicationHealthList {
	if in == nil {
		return nil
	}
	out := new(ApplicationHealthList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ApplicationHealthSpec) DeepCopy() *ApplicationHealthSpec {
	if in == nil {
		return nil
	}
	out := new(ApplicationHealthSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ApplicationHealthStatus) DeepCopyInto(out *ApplicationHealthStatus) {
	*out = *in
	out.LastSyncOperation = in.LastSyncOperation
	out.LastHealth = in.LastHealth
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastHealth) DeepCopyInto(out *LastHealth) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastHealth.
func (in *LastHealth) DeepCopy() *LastHealth {
	if in == nil {
		return nil
	}
	out := new(LastHealth)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastSyncOperation) DeepCopyInto(out *LastSyncOperation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastSyncOperation.
func (in *LastSyncOperation) DeepCopy() *LastSyncOperation {
	if in == nil {
		return nil
	}
	out := new(LastSyncOperation)
	in.DeepCopyInto(out)
	return out
}
